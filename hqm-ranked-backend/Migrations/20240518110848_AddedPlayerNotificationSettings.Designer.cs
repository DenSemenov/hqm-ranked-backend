...
namespace hqm_ranked_backend.Migrations
{
    ...
    [Migration("20240518110848_AddedPlayerNotificationSettings")]
    partial class AddedPlayerNotificationSettings
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hqm_ranked_backend.Models.DbModels.Player", b =>
                {
                    ...
                    b.Property<List<string>>("PushTokens")
                        .IsRequired()
                        .HasColumnType("text[]");
            ...
            modelBuilder.Entity("hqm_ranked_backend.Models.DbModels.PlayerNotificationSetting", b =>
                {
                    ...
                    b.Property<bool>("GameStartedWithMe")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("hqm_ranked_backend.Models.DbModels.Player", b =>
                {
                    b.HasOne("hqm_ranked_backend.Models.DbModels.PlayerNotificationSetting", "NotificationSetting")
                        .WithMany()
