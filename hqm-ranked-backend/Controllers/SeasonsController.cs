...
namespace hqm_ranked_backend.Controllers
{
    ...
    public class SeasonsController : ControllerBase
    {
        ...
        [HttpPost("GetPlayerLiteData")]
        public async Task<IActionResult> GetPlayerLiteData(PlayerRequest request)
        {
            var result = await _seasonService.GetPlayerLiteData(request);
        ...
        public async Task<IActionResult> Report(PlayerReportRequest request)
        {
            ...
            var result = await _seasonService.Report(request.GameId, request.Id, request.ReasonId, request.Tick, userId);
        ...
        public async Task<IActionResult> ReportDecision(ReportDecisionRequest request)
        {
            var userId = UserHelper.GetUserId(User);
            await _seasonService.ReportDecision(request.Id, userId, request.IsReported);
