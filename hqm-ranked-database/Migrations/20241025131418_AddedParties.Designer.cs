...
namespace hqm_ranked_database.Migrations
{
    ...
    [Migration("20241025131418_AddedParties")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("hqm_ranked_database.DbModels.WeeklyTourneyParty", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WeeklyTourneyParties");
                });

            modelBuilder.Entity("hqm_ranked_database.DbModels.WeeklyTourneyPartyPlayer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("WeeklyTourneyPartyId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WeeklyTourneyPartyId");

                    b.ToTable("WeeklyTourneyPartyPlayers");
                });
            ...
            modelBuilder.Entity("hqm_ranked_database.DbModels.WeeklyTourneyPartyPlayer", b =>
                {
                    ...
                    b.HasOne("hqm_ranked_database.DbModels.WeeklyTourneyParty", "WeeklyTourneyParty")
                        .WithMany("WeeklyTourneyPartyPlayers")
                        .HasForeignKey("WeeklyTourneyPartyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("Player");

                    b.Navigation("WeeklyTourneyParty");
                });
            ...
            modelBuilder.Entity("hqm_ranked_database.DbModels.WeeklyTourney", b =>
                {
                    ...
                    b.Navigation("WeeklyTourneyParties");
            ...
            modelBuilder.Entity("hqm_ranked_database.DbModels.WeeklyTourneyParty", b =>
                {
                    b.Navigation("WeeklyTourneyPartyPlayers");
                });
